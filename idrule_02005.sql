/*tables ayant les memes colonnes et de memes type et de meme taille*/
...
type = SQL
basetype  = sqlserver
url = https://docs.microsoft.com/fr-fr/sql/t-sql/functions/col-length-transact-sql?view=sql-server-2017
etat = 1 */
